...
function () {
  ...
  View.prototype.render = function () {
    this.parent.innerHTML = ""; // cleaning the content every render
...
},{"../views/View":"src/views/View.ts"}],"src/views/UserList.ts":[function(require,module,exports) {
"use strict";
...
},{"../views/CollectionView":"src/views/CollectionView.ts","./UserShow":"src/views/UserShow.ts"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
